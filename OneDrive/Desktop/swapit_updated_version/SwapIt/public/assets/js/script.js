    ...
    if (user) {
      ...
      if (mainNavMenu) {
        mainNavMenu.innerHTML = `
          <a href="/public/pages/dashboard.html"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
          <a href="/public/pages/browse.html"><i class="fas fa-search"></i> Browse Items</a>
          <a href="/public/pages/add-listing.html"><i class="fas fa-plus-circle"></i> Add Listing</a>
          <a href="/public/pages/wishlist.html"><i class="fas fa-heart"></i> Wishlist</a>
          <a href="/public/pages/cart.html"><i class="fas fa-shopping-cart"></i> Cart</a>
        `;
      }
      ...
      if (navDrawer) {
        navDrawer.innerHTML = `
          ...
          <a href="/public/pages/profile.html"><i class="fas fa-user"></i> Profile</a>
      ...
      accountMenu.innerHTML = `
        <a href="/public/pages/dashboard.html"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
        <a href="/public/pages/profile.html"><i class="fas fa-user"></i> Profile</a>
        <a href="/public/pages/add-listing.html"><i class="fas fa-plus"></i> Add Listing</a>
      ...
      if (navDrawer) {
        navDrawer.innerHTML = `
          ...
          <hr style="margin: 16px 0; border: none; border-top: 1px solid #1e2434;">
          <div class="nav__auth">
            <a class="btn btn--outline w-100 mb-2" href="/public/pages/login.html">Log in</a>
            <a class="btn btn--primary w-100" href="/public/pages/signup.html">Sign up</a>
          </div>
        `;
      }
      ...
      // Update account dropdown
      accountMenu.innerHTML = `
        <a href="/public/pages/login.html"><i class="fas fa-sign-in-alt"></i> Login</a>
        <a href="/public/pages/signup.html"><i class="fas fa-user-plus"></i> Sign Up</a>
      `;
    }
  } catch (error) {
